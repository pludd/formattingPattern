...
* General comments
*** As long as ICA and suppler understand one another, no one necessarily needs to do anything.
*** But difficult to make recommendations without knowing final overall requirements.

* Tips for UI and system architecture
*** To the extent possible, build your UI as close to XML schema as possible.
